        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[3.2fr_2.2fr_2.6fr_4fr] gap-10 mb-14">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex bg-[#050814] border border-white/12 rounded-full px-5 py-1 gap-2.5 items-center h-[52px] mt-4">
              ...
              <button type="button" className="w-[42px] h-[42px] bg-[#1A5CDD] border-none rounded-full flex items-center justify-center text-white cursor-pointer transition-all duration-200 hover:scale-[1.05] hover:bg-[#154ebc]" style={{ borderRadius: "50%" }} aria-label="Subscribe newsletter">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
